```{r}
# Set flag to true if packages should be installed
INSTALL_LIBS = FALSE
...
turn_into_wide <- function(df){
  # Turns dataframe back into wide format with the genre combinations
  df$value <- 1  
...
Filme besitzen. Gemäss dem vorherigen Plot wird die Grafik auch getrübt, dadurch, dass gewisse Filme über mehrere Genres verfügen.
