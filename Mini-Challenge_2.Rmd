...
Der Plot zeigt klar, dass die meisten Similarities sich tatsächlich im Bereich grösser als 0.8 befinden, was im oberen Boxplot der Top-N Empfehlungen pro User eine Streuung von 0 für alle Top-N Resultate impliziert.
...
Wenn wir einen Vegleich der Anzahl der Filme machen, die die User geliket haben, können wir auch feststellen, dass viel weniger Informationen über die Präferenz des Nutzers 133 vorhanden ist. Dies hat zur Folge, dass weniger Informationen in unser Recommender System als Input geliefert werden, deshalb vermuten wir, dass darum eher grössere Abweichungen zwischen dem empfohlenen Profil zum tatsächlich gesehenen Profil erkennbar sind.
